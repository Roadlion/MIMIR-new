...
ASSET_TO_TICKER = {
    ...
    "rboB gasoline": "RB=F",
    "heating oil": "HO=F",
    "copper": "COPX",  # Mapped to COPX ETF for Guerilla Quant pair correlation
    "aluminium": "ALI=F",
    "zinc": "^NQCIZNTR",
    "nickel": "^NQCINIER",
    "wheat": "WEAT",   # Mapped to WEAT ETF for Guerilla Quant
    "corn": "CORN",    # Mapped to CORN ETF for Guerilla Quant
    "soybeans": "SOYB", # Mapped to SOYB ETF for Guerilla Quant
    "soybean meal": "ZM=F",
    "soybean oil": "ZL=F",
    "oats": "ZO=F",
    "rough rice": "ZR=F",
